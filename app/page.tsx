...
export default function Home() {
  ...
  useEffect(() => {
    // localStorage.clear();
    if (localStorage.getItem("To Do") === null) localStorage.setItem("To Do", JSON.stringify({}));
    if (localStorage.getItem("In Progress") === null) localStorage.setItem("In Progress", JSON.stringify({}));
    if (localStorage.getItem("Completed") === null) localStorage.setItem("Completed", JSON.stringify({}));
    setToDoTaskList(JSON.parse(localStorage.getItem("To Do") as string));
    setInProgressTaskList(JSON.parse(localStorage.getItem("In Progress") as string));
    setComletedTaskList(JSON.parse(localStorage.getItem("Completed") as string));
  }, []);
  return (
      ...
      <div className="w-full h-[calc(100vh-100px)] pb-5 pt-8 px-5">
        <div className="status-card">
          ...
          <div className="task-list">
            {(JSON.stringify(toDoTaskList) === '{}') ? (null) : (
        ...
        <div className="status-card">
          ...
          <div className="task-list">
            {(JSON.stringify(inProgressTaskList) === '{}') ? (null) : (
        ...
        <div className="status-card">
          ...
          <div className="task-list">
            {(JSON.stringify(completedTaskList) === '{}') ? (null) : (
